 ...
 * @author chicu
 */
public class FrmTimTDHV extends javax.swing.JPanel {

    NhanVienBUS nvbus = new NhanVienBUS();
    DefaultTableModel defaultTableModel;

    /**
     * Creates new form FrmNhanVienHV
     */
    public FrmTimTDHV() {
        initComponents();
    ...
    public FrmTimTDHV(JButton btn, JDialog dialog) {
        initComponents();
        this.btn = btn;
        this.dialog = dialog;
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/Images/buttonsearch.png"))); // NOI18N
        ...
        jLabel2.setText("Thông tin học vấn");
