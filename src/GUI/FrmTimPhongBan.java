 ...
 * @author chicu
 */
public class FrmTimPhongBan extends javax.swing.JPanel {
    ...
    public FrmTimPhongBan(JButton btn, JDialog dialog) {
        initComponents();
        this.btn = btn;
        this.dialog = dialog;
